    ...
    return Column(
      ...
      children: [
        ...
        CommonTextField(
          ...
          isRequired: true,
          validator: RequiredValidator(errorText: "Please enter reference $number full name").call,
        ),
        const SizedBox(height: 16),
        CommonTextField(
          label: 'Business Name',
          ...
          // isRequired: true,
          // validator: RequiredValidator(errorText: "Please enter reference $number business name").call,
        ),
        const SizedBox(height: 16),
        CommonTextField(
          label: 'Relationship',
