...
import 'package:catch_ride/view/trainer/bookings/bookings_screen.dart';
import 'package:catch_ride/view/trainer/inbox/inbox_screen.dart';
import 'package:catch_ride/view/trainer/menu/menu_screen.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
           ...
           BottomNavigationBarItem(icon: Icon(Icons.access_time), activeIcon: Icon(Icons.access_time_filled), label: 'Availability'),
