...
class GroomPrivacyView extends StatefulWidget {
  const GroomPrivacyView({super.key});

  @override
  State<GroomPrivacyView> createState() => _GroomPrivacyViewState();
}

class _GroomPrivacyViewState extends State<GroomPrivacyView> {
