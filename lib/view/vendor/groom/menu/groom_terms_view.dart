...
class GroomTermsView extends StatefulWidget {
  const GroomTermsView({super.key});

  @override
  State<GroomTermsView> createState() => _GroomTermsViewState();
}

class _GroomTermsViewState extends State<GroomTermsView> {
