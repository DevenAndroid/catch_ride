...
class _GroomingDetailsViewState extends State<GroomingDetailsView> {
  ...
  Widget _buildGroomingServices(GroomingDetailsController controller) {
    return _buildSectionContainer(
      ...
      children: [
        Obx(
          () => Wrap(
            ...
            children: controller.groomingServicesList.map((service) {
              final isSelected = controller.selectedGroomingServices.contains(
                service,
              );
        ...
        _buildActionLink(
          '+ Add Service',
          onTap: () => _showAddServiceBottomSheet(context, controller),
        ),
      ],
    );
  }
    ...
    return _buildSectionContainer(
      ...
      children: [
        ...
        _buildPriceField(
          ...
          showDaysToggle: true,
          daysRx: controller.weeklyRateDays,
        ),
        const SizedBox(height: 20),
        _buildPriceField(
          'Monthly Rate',
          ...
          showDaysToggle: true,
          daysRx: controller.monthlyRateDays,
        ),
      ],
    );
  }
          ...
          () => Wrap(
            ...
            children: controller.supportOptions.map((item) {
              ...
              return _buildSelectableChip(
                item,
                isSelected: isSelected,
                onTap: () => controller.toggleSupport(item),
              );
            }).toList(),
          ),
        ),
          ...
          () => Wrap(
            ...
            children: controller.handlingOptions.map((item) {
              ...
              return _buildSelectableChip(
                item,
                isSelected: isSelected,
                onTap: () => controller.toggleHandling(item),
              );
            }).toList(),
          ),
        ),
  ...
  Widget _buildAdditionalServices(GroomingDetailsController controller) {
    return _buildSectionContainer(
      ...
      description:
          'Optional services offered in addition to your standard work',
      children: [
        Obx(
          () => Column(
          ...
          () => Wrap(
            ...
            children: controller.travelOptions.map((item) {
              ...
              return _buildSelectableChip(
                item,
                isSelected: isSelected,
                onTap: () => controller.toggleTravel(item),
              );
            }).toList(),
          ),
        ),
  ...
  void _showAddServiceBottomSheet(
    ...
    GroomingDetailsController controller, {
      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 32),
            CommonText(
              isAdditional ? 'Additional Services' : 'Add Service',
  ...
  Widget _buildChipsList(String label, List<String> items) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 6),
        CommonText(
          'Select the disciplines you have the most experience with',
          fontSize: 12,
          color: AppColors.textSecondary,
          fontWeight: FontWeight.w500,
        ),
