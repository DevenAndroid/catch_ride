...
class ApplicationCompleteClippingScreen extends StatefulWidget {
  final bool isLastForm;
  final VoidCallback onContinue;

  const ApplicationCompleteClippingScreen({
    super.key,
  ...
  @override
  State<ApplicationCompleteClippingScreen> createState() =>
      _ApplicationCompleteClippingScreenState();
}

class _ApplicationCompleteClippingScreenState
    extends State<ApplicationCompleteClippingScreen> {
  ...
  void _submit() {
    ...
    if (_selectedExp == null) {
      _err('Missing Field', 'Please select your clipping experience.');
      return;
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Clipping Application'),
        centerTitle: true,
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'This application confirms your professionalism, equipment readiness, and scope of operations.',
            ...
            // 2. Experience
            _header(
              'Years of Professional Clipping Experience',
              required: true,
            ),
