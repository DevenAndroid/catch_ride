...
class BraidingViewProfile extends StatefulWidget {
  ...
  @override
  State<BraidingViewProfile> createState() => _BraidingViewProfileState();
}

class _BraidingViewProfileState extends State<BraidingViewProfile> with SingleTickerProviderStateMixin {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTabs(),
                  const CommonText('Details', fontSize: AppTextSizes.size16, fontWeight: FontWeight.bold),
                  const SizedBox(height: 16),
                  _buildDetailsCard(),
                  const SizedBox(height: 24),
                  _buildPhotosSection(),
          ...
          children: [
            SizedBox(
              ...
              child: const CommonImageView(
                url: 'https://images.unsplash.com/photo-1599406560962-f72535032a11?q=80&w=2071&auto=format&fit=crop', // Horse show banner style
                fit: BoxFit.cover,
              ),
            ),
            Positioned(
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 4),
              const CommonText('Braider  •  10+ Years', fontSize: AppTextSizes.size14, color: AppColors.textSecondary, fontWeight: FontWeight.w600),
            ],
          ),
        ),
      ],
  ...
  Widget _buildBio() {
    return const Padding(
      ...
      child: CommonText(
        'Professional hunter/jumper braider with 6+ years of experience on the A/AA circuit, including Wellington, Ocala, Tryon, and Northeast shows. Specializing in clean, consistent hunter and jumper braids with a focus on durability and polished turnout. Reliable, ... see more',
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            _buildPhotoItem('https://images.unsplash.com/photo-1599406560962-f72535032a11?q=80&w=200'),
    ...
    return Column(
      children: [
        ...
        _buildAvailabilityCard(
          ...
          tags: ['Show Week Support', 'Full - in / Daily Show Support'],
