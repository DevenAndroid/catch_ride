...
import 'package:catch_ride/view/vendor/braiding/menu/braiding_support_tickets_view.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class BraidingHelpView extends StatefulWidget {
  const BraidingHelpView({super.key});

  @override
  State<BraidingHelpView> createState() => _BraidingHelpViewState();
}

class _BraidingHelpViewState extends State<BraidingHelpView> {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 24),
                  GestureDetector(
                    onTap: () => Get.to(() => const BraidingSupportTicketsView()),
                    child: Container(
