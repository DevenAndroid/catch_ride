...
class BraidingPrivacyView extends StatefulWidget {
  const BraidingPrivacyView({super.key});

  @override
  State<BraidingPrivacyView> createState() => _BraidingPrivacyViewState();
}

class _BraidingPrivacyViewState extends State<BraidingPrivacyView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const CommonText('Privacy Policy', fontSize: 18, fontWeight: FontWeight.bold, color: AppColors.textPrimary),
      ...
      body: Obx(() {
        ...
        if (supportController.privacyPolicy.isEmpty) return const Center(child: CommonText('No content available', color: AppColors.textSecondary));
