          ...
          return ListTile(
            ...
            subtitle: Row(
              children: [
                Expanded(
                  child: Text(
                    isUnread ? 'New inquiry about the horse availability...' : 'Thanks for the update!',
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                    style: isUnread 
                        ? AppTextStyles.bodyMedium.copyWith(color: AppColors.deepNavy, fontWeight: FontWeight.w600)
            ...
            onTap: () {
              Get.to(() => ChatDetailScreen(userName: 'User Name ${index + 1}'));
            },
          );
        },
      ),
