...
class BarnManagerProfileCompleteScreen extends StatelessWidget {
  const BarnManagerProfileCompleteScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(BarnManagerProfileController());
